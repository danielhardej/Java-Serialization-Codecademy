...
public class Player implements Serializable{
  ...
  public Player(String name) {
    ...
    this.health = 100;
    this.helmet = new Helmet("Leather Cap", 10, 5);
    this.shirt = new Shirt("Denim Shirt", 10, 5);
    this.trouser = new Trouser("Denim Trousers", 10, 5);
    this.shoe = new Shoe("Leather Boots", 10, 5);
